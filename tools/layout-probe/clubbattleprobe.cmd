@echo off
REM Build+run clubbattleprobe (x86) — offsetof for GLCLUBBATTLE_LOBY. Does not modify SOURCE/.
setlocal
cd /d "%~dp0"
...
cl /nologo /EHsc /W1 /DWIN32 /D_WINDOWS ^
   ...
   /I"%SRC%\Tik\Include" ^
   /I"%SRC%\Tik\DXInclude" ^
   clubbattleprobe.cpp "%SRC%\Lib_Network\minTea.cpp" ^
   /Fe:clubbattleprobe.exe /Foobj\ ^
