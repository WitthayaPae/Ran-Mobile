@echo off
REM Build+run charinfoprobe (x86) — offsetof for SCHARINFO_LOBBY. Does not modify SOURCE/.
setlocal
cd /d "%~dp0"
...
cl /nologo /EHsc /W1 /DWIN32 /D_WINDOWS ^
   ...
   /I"%SRC%\Tik\Include" ^
   /I"%SRC%\Tik\DXInclude" ^
   charinfoprobe.cpp "%SRC%\Lib_Network\minTea.cpp" ^
   /Fe:charinfoprobe.exe /Foobj\ ^
