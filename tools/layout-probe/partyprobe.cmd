@echo off
REM Build+run partyprobe (x86) — offsetof for PARTYLINKDATA / party-search
REM wire structs. Does not modify SOURCE/.
setlocal
cd /d "%~dp0"
...
cl /nologo /EHsc /W1 /DWIN32 /D_WINDOWS ^
   ...
   /I"%SRC%\Tik\Include" ^
   /I"%SRC%\Tik\DXInclude" ^
   partyprobe.cpp "%SRC%\Lib_Network\minTea.cpp" ^
   /Fe:partyprobe.exe /Foobj\ ^
