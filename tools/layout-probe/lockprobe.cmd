@echo off
REM Build+run lockprobe (x86) — offsetof/sizeof + resolved opcodes for the
REM SECURITY/LOCK (equipment/storage/inventory PIN-lock) wire structs.
...
cl /nologo /EHsc /W1 /DWIN32 /D_WINDOWS ^
   ...
   /I"%SRC%\Tik\Include" ^
   /I"%SRC%\Tik\DXInclude" ^
   lockprobe.cpp "%SRC%\Lib_Network\minTea.cpp" ^
   /Fe:lockprobe.exe /Foobj\ ^
