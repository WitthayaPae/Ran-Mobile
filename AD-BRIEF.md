...
A wide flat shop signboard filling the entire image edge to edge, bright lemon-yellow painted metal panel with a thin orange stripe along the top and bottom edges, the words "RAN LEGACY M MARKET" in huge bold condensed sans-serif capitals across the full width, "RAN LEGACY M" in bright red and "MARKET" in royal blue, every letter with a thick black outline, flat front view, no perspective, evenly lit, slightly worn paint texture, no logo, no other text, no people, no background visible around the sign, 4:1 wide banner

### min_su_11_04_redbull.dds — the grey painted-wall market sign (4:1 - generate **2048 × 512**, text only)
A wide weathered grey concrete wall panel filling the entire image edge to edge, with faint diagonal shadows and scuff marks, the words "RAN LEGACY M MARKET" hand-painted across the full width in tall condensed capitals, "RAN" in copper-orange, "LEGACY M" in teal, "MARKET" in magenta-pink, each letter with a thin dark-red outline, the paint slightly faded and translucent over the concrete, flat front view, no perspective, soft even daylight, no logo, no other text, no people, 4:1 wide banner
